 ...
 */
final class Version20240421213647 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rating DROP user, CHANGE user_id_id user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rating ADD user VARCHAR(255) NOT NULL, CHANGE user_id user_id_id INT DEFAULT NULL');
